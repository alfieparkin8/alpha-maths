...
const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-alpha-dark">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <a 
            ...
            className="bg-alpha-black border border-gray-800 rounded-xl p-6 hover:border-alpha-blue transition-colors duration-300 group"
          >
          ...
          <a 
            ...
            className="bg-alpha-black border border-gray-800 rounded-xl p-6 hover:border-alpha-green transition-colors duration-300 group"
          >
          ...
          <a 
            href="#" 
            className="bg-alpha-black border border-gray-800 rounded-xl p-6 hover:border-alpha-purple transition-colors duration-300 group"
          >
